package com.github.zombifiedpotato.fantastical_additions.entity.custom;
...
public class FairyPowderEntity extends ThrownItemEntity {
    ...
    public FairyPowderEntity(World world, LivingEntity owner) {
        super((EntityType<? extends ThrownItemEntity>) ModEntities.FAIRY_POWDER, owner, world);
        this.ignoreCameraFrustum = true;
    }

    public FairyPowderEntity(World world, double x, double y, double z) {
        super((EntityType<? extends ThrownItemEntity>) ModEntities.FAIRY_POWDER, x, y, z, world);
        this.ignoreCameraFrustum = true;
    }
